...
This document describes the security-relevant behavior of the current `main` branch, updated for V1.48.0 on 2026-07-26. It is intended as a public description of Mole's safety boundaries, destructive-operation controls, release integrity signals, and known limitations.
